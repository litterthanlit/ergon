      ...
      <div className="w-full max-w-sm">
        ...
        <form action={action} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input name="password" type="password" required className="w-full px-3 py-2 text-[13px] text-ergon-text bg-ergon-surface border border-ergon-border rounded focus:outline-none focus:border-ergon-text transition-colors" />
          </div>
        ...
        <p className="text-[11px] text-ergon-muted mt-6 text-center">
          No account?{" "}<Link href="/signup" className="text-ergon-text underline underline-offset-2">Create one</Link>
        </p>
      </div>
    </div>
  );
